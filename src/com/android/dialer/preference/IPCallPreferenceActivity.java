...
public class IPCallPreferenceActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mipCallPrefix.setSummary(TextUtils.isEmpty(preFixStr) ? context
                .getString(R.string.dialer_ip_call_prefix_summary) : preFixStr);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mipCallPrefix) {
            ...
            new AlertDialog.Builder(this).setTitle(R.string.dialer_ip_call_prefix_title)
                    .setView(layoutIPCallPrefix)
